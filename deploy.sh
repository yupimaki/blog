...
git subtree pull --prefix=public \
	git@github.com:AkhilNairAmey/AkhilNairAmey.github.io.git master -m "Merge origin master"
...
git subtree push --prefix public git@github.com:AkhilNairAmey/AkhilNairAmey.github.io.git master
